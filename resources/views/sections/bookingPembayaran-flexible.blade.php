    ...
    <div class="w-full max-w-3xl bg-[#041233] rounded-3xl border border-slate-800 p-6 md:p-8 shadow-xl">
        ...
        <div id="paymentStep" class="{{ $isUploadState ? 'hidden' : '' }}">
            ...
            <div class="text-center">
                ...
                <p class="text-sm md:text-base text-slate-400 mb-8 md:mb-10">
                ...
                {{-- Total --}}
                <h3 class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent mt-8 mb-10">
            ...
            {{-- Footer --}}
            <div class="mt-8 border-t border-slate-800 pt-8 flex flex-col-reverse sm:flex-row justify-between gap-4">

                <a href="{{ route('booking.session.flexible') }}"
                   class="w-full sm:w-auto justify-center px-8 py-3 border border-slate-700 rounded-xl text-white hover:border-blue-500 transition flex items-center gap-2">
                ...
                <button type="button" onclick="showUploadStep()"
                    class="w-full sm:w-auto justify-center px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold shadow-lg hover:scale-105 transition flex items-center gap-2">
                ...
                <div class="mt-8 border-t border-slate-800 pt-8 flex flex-col-reverse sm:flex-row justify-between gap-4">
                    ...
                    @if($isRetry ?? false)
                        <a href="{{ route('booking.waiting-verification.flexible') }}"
                            class="w-full sm:w-auto px-8 py-3 border border-slate-700 rounded-xl text-white hover:border-blue-500 transition flex items-center justify-center gap-2">
                            <svg class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 18 9 12 15 6"/></svg>
                    ...
                    <button type="submit" id="submitBtn" disabled
                        class="w-full sm:w-auto px-8 py-3 rounded-full bg-gradient-to-r from-purple-500 to-blue-500 text-white font-semibold shadow-lg transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 hover:scale-105">
                        <span id="submitText">
                            @if($isRetry ?? false)
