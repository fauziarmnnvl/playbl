...
class PlayboxSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $playboxData = [
            ...
            ['id_cabang' => $cabangNud->id_cabang, 'nama_playbox' => 'PB-N3', 'status_mesin' => 'Digunakan'],
            ...
            ['id_cabang' => $cabangNud->id_cabang, 'nama_playbox' => 'PB-N7', 'status_mesin' => 'Selesai'],
            ...
            ['id_cabang' => $cabangPalio->id_cabang, 'nama_playbox' => 'PB-P3', 'status_mesin' => 'Digunakan'],
            ...
            ['id_cabang' => $cabangPalio->id_cabang, 'nama_playbox' => 'PB-P7', 'status_mesin' => 'Selesai'],
            ...
            ['id_cabang' => $cabangPirzy->id_cabang, 'nama_playbox' => 'PB-E3', 'status_mesin' => 'Digunakan'],
            ...
            ['id_cabang' => $cabangPirzy->id_cabang, 'nama_playbox' => 'PB-E7', 'status_mesin' => 'Selesai'],
            ...
            ['id_cabang' => $cabangWaroeng->id_cabang, 'nama_playbox' => 'PB-W3', 'status_mesin' => 'Digunakan'],
            ...
            ['id_cabang' => $cabangWaroeng->id_cabang, 'nama_playbox' => 'PB-W7', 'status_mesin' => 'Selesai'],
